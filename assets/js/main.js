...
/*=============== SWIPER ACHIEVEMENT ===============*/
let swiperAchievement = new Swiper(".achievement__container", {
    grabCursor: true,
...
//         emailjs.sendForm('service_1q5yq6m', 'template_1', '')
...
sr.reveal(`.home__data, .projects__container, .achievement__container, .footer__container`)
sr.reveal(`.home__info div`, {delay: 200, origin: 'bottom'})
